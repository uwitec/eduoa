...
if (!objPHPDate)
{
	var objPHPDate =
	{
		...
		aLetterDay: ['日', '一', '二', '三', '四', '五', '六'],
		aMonth: ['一月', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
		aShortMonth: ['一月', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
...
function DateChooser()
{
	...
	var RefreshDisplay = function()
	{
		...
		ndA.setAttribute('href', '#');
		ndA.setAttribute('title', '当前日期');
		ndTH.appendChild(ndA);
		ndA.appendChild(document.createTextNode(objMonthYear.getPHPDate("Y M")));
